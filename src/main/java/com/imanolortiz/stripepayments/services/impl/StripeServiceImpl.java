...
public class StripeServiceImpl implements StripeService {
    ...
    public CheckoutResponse createCheckout(CheckoutRequest checkoutRequest) {
        ...
        var session = SessionCreateParams
                .builder()
        ...
        try {
            return Optional.of(Session.create(session))
                    .map(sessionCreated -> CheckoutResponse
                            .builder()
    ...
    private String getPriceIdForProduct(String productId){
        ...
        return prices.stream().findFirst().map(Price::getId).orElseThrow(() -> new RuntimeException("Price not found"));
    }
